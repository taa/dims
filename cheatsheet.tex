...
\section{TODO}
  \begin{enumerate}
    ...
    \item Partiel orden % Lasse
    \item Størrelsesorden (fx $n^3$ og $2^n$)
    \item Komplekse tal
    \item Topologisk ordning % Lasse
    \item Ordensrelationer % Lasse
  \end{enumerate}
\section{Faktorisering}
 ...
 Gæt en rod. Brug polynomiers division. Simplifiser til en anden gradsligning.
\section{Kompleks Faktorisering}
 Faktoriser ved at gætte samt polynomiers division. Når der ikke er flere reelle rødder findes de resterende trvielt som komplekse.
  ...
  \subsubsection{Irrefleksiv}
    ...
    \begin{equation}
      \forall x \in \mathbb{R}: x\not{R}x %TODO Skal lave et overstreget R
      					  %overstregninger laves med \overline{snot}
    \end{equation}
